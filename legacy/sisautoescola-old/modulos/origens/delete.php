...
$countUso = $mysql->getValue('count(id) as total', 'total', 'alunos', "idorigem = '".$id."'");

if ($countUso > 0) {
    $msgValidacao["msg"][] = "Esta origem já foi usada em um aluno e não pode ser excluída.";
    $validacao = false;
}

if ($validacao) {
    if ($mysql->delete('origens', "id = '".$id."'")) {
