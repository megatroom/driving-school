...
$loginAdmin = $mysql->getValue('login', 'login', 'usuarios', "id = '".$id."'");
if (isset ($loginAdmin) and $loginAdmin == "admin") {
    $msgValidacao["msg"][] = "Não é possível deletar o usuário Admin, por motivos de segurança.";
    $validacao = false;
}

if ($validacao) {
    if ($mysql->delete('usuarios', "id = '".$id."'")) {
