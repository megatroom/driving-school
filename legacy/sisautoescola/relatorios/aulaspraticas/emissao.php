...
foreach ($lstCarros as $carro) {
  ...
  $linhas = $mysql->select(
    "distinct a.idcarro, a.hora, b.nome, b.cpf, b.matriculacfc, a.comentario",
...
function tabelaInstrutor($rel, $func, $data, $nomeFunc, $carro)
{
  ...
  $rel->newCel("Aluno");
  $rel->newCel("CPF", array("width" => "10%"));
  $rel->newCel("Comentários", array("width" => "30%"));
  $rel->closeLine();
}
