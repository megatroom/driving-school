...
$mainGridCli = new modulos_global_grid('mainGrdAluno', 'Alunos', 'modulos/alunos/index.xml.php', $pColNames, $pColModel, $pSortName, true);
...
if ($acesso->getFuncionalidade(1)) {
    $form->buttonNew('bNewAluno','Novo Aluno','modulos/alunos/form.php');
}
if ($acesso->getFuncionalidade(2)) {
    $form->buttonAlt('bAltAluno',null,$mainGridCli->getGridName(), 'id', 'modulos/alunos/form.php');
}
if ($acesso->getFuncionalidade(3)) {
    $form->buttonExc('bExcAluno',null,$mainGridCli->getGridName(), 'id', 'modulos/alunos/index.php', 'modulos/alunos/delete.php');
}
...
if ($acesso->getFuncionalidade(2)) {
    $mainGridCli->eventOnDblClickRowAlterRow('id', 'modulos/alunos/form.php');
}
