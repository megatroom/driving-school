...
$countTable = $mysql->getValue('count(a.id) as total','total','bonus a, vfuncionarios b',$where);

//echo $mysql->getMsgErro()."<br>";
$xmlMainFun = new modulos_global_gridxml($page, $limit, $countTable);

$rows = $mysql->select('a.id, b.nome, a.data, a.valor', 'bonus a, vfuncionarios b', $where, "order by $sidx $sord LIMIT ".$xmlMainFun->getStart()." , ".$xmlMainFun->getLimit()." ");
//echo $mysql->getMsgErro()."<br>";
