...
<body>
  ...
  if ($authenticated) {
    ...
    <div id="indexTopo"
      style="position:absolute; left: 10px; top: 10px; right: 10px; width:auto; height: 90px; padding: 5px;"
    ...
    if ($window == 1) {
      ...
      ?>
      <div id="windowBox" style="position:absolute; left: 10px; right: 10px; top: 120px; min-height: 507px; width:auto;"
    ...
    <table width="100%" border="0">
      <tr>
        <td align="center" valign="middle">
          <div id="windowBox" style="width:350px;margin-top: 80px;"
            class="ui-dialog ui-widget ui-widget-content ui-corner-all">
            <div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix">
              <span id="windowTitle" class="ui-dialog-title">Bem Vindo</span>
            </div>
